const MobileQuestionModule = () => {
  return (
    <section id='module-questions' className='module module-questions hidden'>
      <div
      ...
      <div
        ...
        <svg
          ...
          fill='none'
          xmlns='http://www.w3.org/2000/svg'>
          <rect width='48' height='4' rx='2' fill='#2874FF' fillOpacity='0.3' />
        </svg>
...
export default MobileQuestionModule
